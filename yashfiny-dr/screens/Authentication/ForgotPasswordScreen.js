...
import {  Image, StyleSheet, View, TextInput, TouchableOpacity , Text, KeyboardAvoidingView, Platform} from 'react-native';
...
const ForgotPasswordScreen = ({navigation}) => {
    ...
    >
      ...
      <View style={styles.fpContainer}>
        <Icon name="lock" type='font-awesome' color={Colors.primary600} size={80}></Icon>
